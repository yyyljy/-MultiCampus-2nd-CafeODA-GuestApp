package com.example.cafeoda.FCM;
    ...
    class SendTokenThread extends Thread{
        ...
        public void run() {
            ...
            try {
                ...
                builder = builder.url("http://"+ip+":8088/cafeoda/fcm/fcm_check?id="+myid+"&token="+token);
    ...
    class requestThread extends Thread{
        ...
        public void run() {
            ...
            try {
                OkHttpClient client = new OkHttpClient();
                Request.Builder builder = new Request.Builder();
                builder = builder.url("http://"+ip+":8088/cafeoda/fcm/sendClient?sendId="+sendId+"&recvId="+recvId);
                Request request = builder.build();
                Call newcall = client.newCall(request);
                newcall.execute();
            } catch (IOException e) {
